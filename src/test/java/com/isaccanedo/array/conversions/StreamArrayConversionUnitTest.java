package com.isaccanedo.array.conversions;

import static com.isaccanedo.array.conversions.StreamArrayConversion.intStreamToPrimitiveIntArray;
import static com.isaccanedo.array.conversions.StreamArrayConversion.integerStreamToIntegerArray;
import static com.isaccanedo.array.conversions.StreamArrayConversion.stringStreamToStringArrayUsingFunctionalInterface;
import static com.isaccanedo.array.conversions.StreamArrayConversion.stringStreamToStringArrayUsingLambda;
import static com.isaccanedo.array.conversions.StreamArrayConversion.stringStreamToStringArrayUsingMethodReference;
import static com.isaccanedo.array.conversions.StreamArrayConversion.stringArrayToStreamUsingArraysStream;
import static com.isaccanedo.array.conversions.StreamArrayConversion.stringArrayToStreamUsingStreamOf;
import static com.isaccanedo.array.conversions.StreamArrayConversion.primitiveIntArrayToStreamUsingArraysStream;
import static com.isaccanedo.array.conversions.StreamArrayConversion.primitiveIntArrayToStreamUsingStreamOf;
...
public class StreamArrayConversionUnitTest {
    ...
    private String[] stringArray = new String[]{"isaccanedo", "convert", "to", "string", "array"};
